...
querys = ['NP-1', 'GÁS NATURAL', 'ET-5400.00-1230-797-PEI-001', 'NBR-14039',
          '60470', 'IEEE 1665', 'ENG-RLE/PROJEN 3']
...
for a in range(0, 10):
    ...
    if 'hits' in search:
        jsonstr = {
            "query": querys[posquer], "metodo": methods[posmeth], "timestamp": datetime.datetime.now().strftime("%Y/%m/%d %H:%M:%S"), "limit": 20, "offset": 0, "documents": [], "interacao": []
        }
